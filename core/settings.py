...
SECRET_KEY = 'django-insecure-eiok^zmlx&fx#al-2q!33k=joettp-2jd!wyw=9vvr#qt_gzne'
...
ACCOUNT_USERNAME_REQUIRED = False  # username required
ACCOUNT_AUTHENTICATION_METHOD = 'email'
ACCOUNT_EMAIL_VERIFICATION = 'mandatory'

# django-browser-reload settings
BROWSER_RELOAD = True
